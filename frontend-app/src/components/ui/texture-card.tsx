    ...
    <div className="rounded-[23px] border  dark:border-neutral-900/80 border-black/10 ">
      <div className="rounded-[22px] border  dark:border-neutral-950 border-white/50">
        <div className="rounded-[21px] border  dark:border-neutral-900/70  border-neutral-950/20">
          ...
          <div className=" w-full border border-white/50 dark:border-neutral-700/50 rounded-[20px] text-neutral-500 bg-white">
            {children}
          </div>
        </div>
      </div>
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "rounded-[calc(var(--radius,16px))]", // Base radius with fallback
        className
      )}
      {...props}
    >
      <div className="border dark:border-neutral-900/80 border-black/10 rounded-[calc(var(--radius,16px)-1px)]">
        <div className="border dark:border-neutral-950 border-white/50 rounded-[calc(var(--radius,16px)-2px)]">
          <div className="border dark:border-neutral-900/70 border-neutral-950/20 rounded-[calc(var(--radius,16px)-3px)]">
            <div className=" w-full border border-white/50 dark:border-neutral-700/50 text-neutral-500 bg-gradient-to-b from-white/70 to-neutral-50/50 rounded-[calc(var(--radius,16px)-4px)] bg-white">
              {children}
            </div>
          </div>
        </div>
