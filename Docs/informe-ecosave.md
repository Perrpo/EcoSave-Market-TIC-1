...
EcoSave Market es una plataforma anti-desperdicio que conecta **supermercados**, **ONGs** y un **administrador central**. Este informe analiza el estado actual del desarrollo, identifica módulos implementados, detecta inconsistencias y define oportunidades de mejora.
